...
local activeDropdown = nil -- 用来管理当前打开的下拉菜单
		...
		function window:Page(pageInfo)
			...
			function page:Section(sectionInfo)
				...
				function section:Dropdown(dropdownInfo)
					...
					local optionsHolder = utility:Create({Type = "ScrollingFrame", Properties = {Parent = screen, BackgroundColor3 = Color3.fromRGB(45, 45, 45), BorderColor3 = Color3.fromRGB(1, 1, 1), BorderSizePixel = 1, ClipsDescendants = true, Visible = false, ZIndex = 100, ScrollBarThickness = 4}})
