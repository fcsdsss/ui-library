...
do
    ...
    function Funcs:AddColorPicker(Idx, Info)
        ...
        local function createDragConnection(element, updateFunction)
            element.InputBegan:Connect(function(input)
                if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
                    ...
                    moveConn = InputService.InputChanged:Connect(function(changedInput)
                        if changedInput.UserInputType == input.UserInputType then
                            updateFunction(changedInput)
                        end
                    end)
                    
                    endConn = InputService.InputEnded:Connect(function(endedInput)
        ...
        createDragConnection(SatVibMap, function(input)
        ...
        createDragConnection(HueSelectorInner, function(input)
        ...
        if TransparencyBoxInner then
            createDragConnection(TransparencyBoxInner, function(input)
    ...
    function Funcs:AddSlider(Idx, Info)
        ...
        SliderInner.InputBegan:Connect(function(Input)
            if (Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch) and not Library:MouseIsOverOpenedFrame() then
                ...
                local function updateSlider(currentInput)
                    local nX = math.clamp(currentInput.Position.X - SliderInner.AbsolutePosition.X, 0, Slider.MaxSize)
